...
import static com.huiyuenet.faceCheck.THFI_Param.IMG_HEIGHT;
import static com.huiyuenet.faceCheck.THFI_Param.IMG_WIDTH;
import static com.huiyuenet.faceCheck.THFI_Param.PICTURE_IMG_HEIGHT;
import static com.huiyuenet.faceCheck.THFI_Param.PICTURE_IMG_WIDTH;
...
public class CameraProxy implements Camera.AutoFocusCallback {
    ...
    private void initConfig() {
        ...
        try {
            ...
            mParameters.setPreviewSize(IMG_WIDTH, IMG_HEIGHT); // 设置预览图片大小
            mParameters.setPreviewFormat(ImageFormat.NV21);
            Log.d(TAG, "previewWidth: " + mPreviewWidth + ", previewHeight: " + mPreviewHeight);
            mParameters.setPictureSize(PICTURE_IMG_WIDTH, PICTURE_IMG_HEIGHT);
