...
//            return 0;
    ...
    public static int M1_ReWriteMifareBlockData(byte cBlockID, byte[] cInCardSID, byte[] cWriteDataInfo, byte[] cInitDataInfo) {
        ...
        //发送打开重写界面
        if ((g_WorkInfo.cCardEnableFlag == 1) && (gUICardHandler != null))
            gUICardHandler.sendEmptyMessage(CARD_RWSTART);
        ...
        //发送关闭重写界面
        if ((g_WorkInfo.cCardEnableFlag == 1) && (gUICardHandler != null))
            gUICardHandler.sendEmptyMessage(CARD_RWEND);
...
//    }
    ...
    public static byte PCheckPassword(int iMode, byte[] cTradePWD) {
        ...
        //发送打开密码键盘
        if ((g_WorkInfo.cCardEnableFlag == 1) && (gUICardHandler != null))
            gUICardHandler.sendEmptyMessage(CARD_PWDKBOPEN);
        ...
        //发送关闭密码键盘
        if ((g_WorkInfo.cCardEnableFlag == 1) && (gUICardHandler != null))
            gUICardHandler.sendEmptyMessage(CARD_PWDKBCLOSE);
