...
public class LocalInfo {
    ...
    public short cPowerSaveTime;             //启用省电模式时长 0-60
    ...
    public short cAccNameShowMode;                //账户显示姓名模式
    ...
    public short getcPowerSaveTime() {
        return cPowerSaveTime;
    }

    public void setcPowerSaveTime(short cPowerSaveTime) {
        this.cPowerSaveTime = cPowerSaveTime;
    }
