...
public class BubbleIndicator {
    ...
    private class Floater extends FrameLayout {
        ...
        public Floater(Context context, AttributeSet attrs, int defStyleAttr, String maxValue) {
            ...
            mMarker.setBackgroundResource(R.mipmap.tick);
            addView(mMarker, new LayoutParams(60, 40, Gravity.LEFT | Gravity.TOP));
        }
        ...
        public void setProgressText(int progress) {
            mMarker.setTextColor(getResources().getColor(R.color.colorWhite));
