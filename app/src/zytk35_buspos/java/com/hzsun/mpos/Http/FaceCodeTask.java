...
public class FaceCodeTask {
    ...
    public void Init() {
        ...
        //gHttpCommInfo.iFaceServeType=1; //测试老版本协议
                    ...
                    public void handleMessage(Message msg) {
                        switch (msg.what) {
                            case HEVT_NULL:
                                ...
                                gHttpCommInfo.lngSendHttpStatus = 0;
                                gHttpCommInfo.cRecvWaitState = 0;
                                g_WorkInfo.cUpdateState = 0;
                                break;

                            case HEVT_GETFACEVER:               //获取特征码版本号
                                Log.d(TAG, "获取特征码版本号");
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000001) == 0x00000001) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000001;
                                    ...
                                    if (strMsg.equals("SUCCESS")) {
                                        ...
                                        //if (g_FaceCodeInfo.lngLocalVer == 0)//初始版本号为0
                                        {
                                            ...
                                            if (iVersion != g_FaceCodeInfo.lngLocalVer) {
                                                ...
                                                if (gHttpCommInfo.iFaceServeType  == 0) {
                                                    //0x00000100 //获取初始图片数据列表
                                                    gHttpCommInfo.lngSendHttpStatus |= 0x00000100;
                                                } else {
                                                    //0x00000002 获取人脸特征码数据表
                                                    gHttpCommInfo.lngSendHttpStatus |= 0x00000002;
                                                }
                                            } else {
                                                if ((iVersion == g_FaceCodeInfo.lngLocalVer)
                                            ...
                                            if (iVersion != g_FaceCodeInfo.lngLocalVer) {
                                                ...
                                                if (gHttpCommInfo.iFaceServeType == 0) {
                                                    ...
                                                    gHttpCommInfo.lngSendHttpStatus |= 0x00000200;
                                                } else {
                                                    //0x00000002 获取变更人脸特征码数据表
                                                    gHttpCommInfo.lngSendHttpStatus |= 0x00000004;
                                                }
                                            }
                                        }
                                    } else {
                            ...
                            case HEVT_GETFACEINITDATA:               //获取初始特征码数据列表
                                ...
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000002) == 0x00000002) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000002;
                                ...
                                try {
                                    ...
                                    if (jsFaceInitDataInfo.getMsg().equals("SUCCESS")) {
                                        ...
                                        if (gUserInfoList.size() != 0) {
                                            ...
                                            gHttpCommInfo.cDownMode = 0;
                                            gHttpCommInfo.cGetFaceCodeState = 1;
                                            gHttpCommInfo.lngSendHttpStatus |= 0x00000002; //再次下载
                                        } else {
                                        ...
                                        if (jsFaceInitDataInfo.getMsg().equals("数据库没有对应的查询记录")) {
                                            ...
                                            FaceCodeInfoRW.WriteAllFaceCodeInfo(g_FaceCodeInfo);
                                            gHttpCommInfo.lngSendHttpStatus |= 0x00000001;
                                        }
                                    }
                                } catch (JsonSyntaxException e) {
                                    e.printStackTrace();
                            ...
                            case HEVT_GETFACEINITPIC:  //获取初始图片数据列表
                                ...
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000100) == 0x00000100) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000100;
                                ...
                                try {
                                    ...
                                    if (jsFaceInitDataInfo.getMsg().equals("SUCCESS")) {
                                        ...
                                        if (jsFaceInitDataInfo.getMsg().equals("数据库没有对应的查询记录")) {
                                            ...
                                            gHttpCommInfo.iFaceServeType = 1;
                                            Log.e("获取老版本特征码", "数据列表");
                                            gHttpCommInfo.lngSendHttpStatus |= 0x00000002;
                                        }
                                    }
                            ...
                            case HEVT_GETFACECHANDATA:               //获取变更特征码数据列表
                                ...
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000004) == 0x00000004) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000004;
                            ...
                            case HEVT_GETFACECHANPIC:  //获取变更图片数据列表
                                ...
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000200) == 0x00000200) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000200;
                            ...
                            case HEVT_GETPHOTOINFO:               //获取用户照片数据地址
                                ...
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000008) == 0x00000008) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000008;
                            ...
                            case HEVT_GETAPPINFO:               //获取程序升级app地址
                                ...
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000010) == 0x00000010) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000010;
                            ...
                            case HEVT_UPLOADRECORD:               //上传人脸流水结果
                                Log.d(TAG, "上传人脸流水结果");
                                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000020) == 0x00000020) {
                                    gHttpCommInfo.lngSendHttpStatus = gHttpCommInfo.lngSendHttpStatus - 0x00000020;
                                    Log.d(TAG, "获取上传人脸流水结果接收");
                                }
                                strRecvData = (String) msg.obj;
                                try {
                                    GetUpRecord jsUpRecordInfo = new Gson().fromJson(strRecvData, GetUpRecord.class);
                                    if (jsUpRecordInfo.getCode().equals("00000")) {
                                        //请求成功
                                        String strGetMag = jsUpRecordInfo.getMsg();
                                        Log.d(TAG, "接收到的Mag:" + strGetMag);
...
//                        Log.e(TAG, "已经存在重复下载:" + j + " acc-" + gUserInfoList.get(j).accnum+ " ver-" + gUserInfoList.get(j).version);
//                        continue;
//                    }
//                }
...
//                        todo  保存bitmap
//                        FileUtils.SavePhotoData(inputStream, ZYTKPicPath, strTemp + ".jpg");
                        iRet = 0;
                        iErrCnt = 0;
                        iReDownFlag=0;
                    } else {
        ...
        public void run() {
            ...
            while (isStart) {
                ...
                if (gHttpCommInfo.cGetFaceCodeState == 0)
                    continue;

                long lngStart = System.currentTimeMillis();
                if (gHttpCommInfo.iFaceServeType == 0) {  //新版本图片特征码服务
                    if (gHttpCommInfo.cDownMode == 0)//判断是初始还是变更
                    {
                        SaveInitFacePicData();
                ...
                gHttpCommInfo.cGetFaceCodeState = 0;//下载完成
            }
        }
    }
        ...
        public void run() {
            ...
            try {
                ...
                if (code == HttpURLConnection.HTTP_OK) {
                    //服务器成功处理了部分 GET 请求。
                    inputStream = connection.getInputStream();
                    FileUtils.SavePhotoData(inputStream, PhotoPath, sPhotoInfo.accnum + ".jpg");
                    String strAccID = GetMultiAccID(sPhotoInfo.accnum);//判断是否是多人脸
                    Message msg = Message.obtain();
                    msg.what = HTTPPHOTO;
                    msg.obj = strAccID;
                    gUICardHandler.sendMessage(msg);
                } else {
                ...
                if (code == HttpURLConnection.HTTP_OK) {
                    ...
                    else
                    {
                        Log.d(TAG, "文件为应用程序apk");
                         //app名称  zytk35_buspos_版本号.apk zytk35_buspos_3.5.19.0508.apk
                        strAPPFileName = "zytk35_buspos_temp.apk";
                        Log.d(TAG, strAPPFileName);
                        ...
                        String strReAPPFileName = "zytk35_buspos_" + g_WorkInfo.strAppSoftWareVer + ".apk";
    ...
    public void SendHttpMsgHand() {
        ...
        if (g_WorkInfo.cRunState == 1) {
            if ((getUnsignedIntt((int) gHttpCommInfo.lngSendHttpStatus) > 0)
                    && (gHttpCommInfo.cRecvWaitState == 0)) {
                //获取用户照片地址(实时获取，卡户校验时)
                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000008) == 0x00000008) {
                    //置位接收标记
                    gHttpCommInfo.cRecvWaitState = 1;
                    //String strAccCode = "" + g_CardBasicInfo.lngAccountID;
                    GetUserPhotoInfo(g_WorkInfo.strAccCode);
                }

                //获取初始人脸特征码数据表
                if ((gHttpCommInfo.lngSendHttpStatus & 0x00000002) == 0x00000002) {
                    if (gHttpCommInfo.cGetFaceCodeState == 1)
                        return;
                ...
                //获取应用程序app地址
                if (((gHttpCommInfo.lngSendHttpStatus & 0x00000010) == 0x00000010) && (g_WorkInfo.cUpdateState == 0)) {
                    //置位接收标记
                    gHttpCommInfo.cRecvWaitState = 1;
        ...
        if ((g_WorkInfo.cRunState == 1)
            ...
            if (slngTimer % 60 == 0) {
                Log.d(TAG, String.format("特征码无法获取:%d-%d-%d-%d", g_WorkInfo.cRunState,
                        ...
                        gHttpCommInfo.lngSendHttpStatus,
                        gHttpCommInfo.cRecvWaitState));
                slngErrCnt++;
                if(slngErrCnt>10){
...
//                        && jsonObject.optString("version")!=null)
                {
                    ...
                    } else if (gHttpCommInfo.iFaceServeType == 1) {
