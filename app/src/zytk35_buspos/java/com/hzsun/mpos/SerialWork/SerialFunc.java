    ...
    public static void showQRError(int iErrorCode) {
        ...
        if (iErrorCode > 0) {
            switch (iErrorCode) {
                case 1:
                    cErrorCode = "超出消费范围";
                    SerialWorkTask.tradeCode = 0x06;
                    break;
                case 13:
                    cErrorCode = "余额不足";
                    SerialWorkTask.tradeCode = 0x05;
                    break;
                case 11:
                    cErrorCode = "操作超时";
                    SerialWorkTask.tradeCode = 0x9F;
                    break;
                case 12:
                    cErrorCode = "订单号过期";
                    SerialWorkTask.tradeCode = 0x07;
                    break;
                case 2:
                case 26:
                    cErrorCode = "无效卡户";
                    SerialWorkTask.tradeCode = 0x02;
                    break;
                case 21:
                case 23:
                    cErrorCode = "消费限次";
                    SerialWorkTask.tradeCode = 0x10;
                    break;
                case 22:
                    cErrorCode = "超出日累限额";
                    SerialWorkTask.tradeCode = 0x09;
                    break;
                case 24:
                    cErrorCode = "超出单笔密码限额";
                    SerialWorkTask.tradeCode = 0x08;
                    break;
                case 97:
                    cErrorCode = "无效二维码";
                    SerialWorkTask.tradeCode = 0x15;
                    break;
                default:
                    cErrorCode = "支付失败";
                    SerialWorkTask.tradeCode = 0x99;
                    break;
            }
