...
public class SoundPlay {
    ...
    private static String SoundPath = Environment.getExternalStorageDirectory().toString() + "/zytk/zytk35_mpos/sound/";
    // 上下文
...
//    }
    ...
    public static synchronized void VoicePlay(String strSound) {
        ...
        if (soundPool != null) {
            ...
            if (soundID == sSoundID) {
                if ((System.currentTimeMillis() - slngStart) < 1500)
                    return;
            }
    ...
    //播放音频
    public static synchronized void VoicePlayA(String strSound) {
        int soundID = 0;
        int state = -1;
