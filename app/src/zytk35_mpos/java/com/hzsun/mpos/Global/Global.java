...
public class Global {
    ...
    //TAG
    public static final String TAGAPP = "zytk35_mpos_";
    //引导app名称
    public static final String IAPAPPFILE_NAME = "ZYTK_IAP_APP.apk";
    //app名称
    public static final String APPFILE_NAME = "zytk35_mpos.apk";
    //软件版本号(中间用.分开)
    public static final String SOFTWAREVER = "3.5.20.01170";
    //以太网电子现金消费机
    public static final int LAN_EP_CONSUMEPOS = 301;
    //以太网电子现金充值机
    public static final int LAN_EP_MONEYPOS = 302;
    //设备类型 DeviceType
    public static final int LAN_DEVTYPE = 0x24;
    //设备类型 DeviceType
    public static final int LAN_OLDDEVTYPE = 0x1C;
    //判断营业分组时长
    ...
    //二维码支付成功显示时长（x*150ms=4.5s）
    public static final int PAYSHOWTIME = 20;
    //测试模式间隔时长
    ...
    //人脸交易记录长度
    public static final int FACEPAYRECORD_LEN = 48;
    //界面退出超时时间 (秒)
    public static final int KEYTIMEOUT = 60;
    //进入省电模式时长
    public static final int POWERSAVETIME = 60;
    //上传交易记录打包笔数
    ...
    //保留日志数量
    public static final int LOGCOUNT = 20;
    //保留抓拍人脸照片数量 1000
    public static final int FACEPICCOUNT = 1000;
    //保留证件照文件夹大小 512M
    public static final int PHOTOFILESIZE = 512*1024*1024;
    ...
    public static final String ZYTK35Path = SDPath + "/zytk/zytk35_mpos/";
    public static final String ZYTKFacePath = SDPath + "/zytk/facepath/";
    public static final String DATAPath = SDPath + "/zytk/zytk35_mpos/data/";
    public static final String PhotoPath = SDPath + "/zytk/zytk35_mpos/photo/";
    public static final String LogPathOld = SDPath + "/zytk/zytk35_mpos/log/";
    public static final String LogPath = SDPath + "/zytk/zytk35_mpos/log1/";
    public static final String LogCrashPath = SDPath + "/zytk/zytk35_mpos/logcrash1/";
    public static final String PicPath = SDPath + "/zytk/zytk35_mpos/pic/";
    public static final String ShellPath = SDPath + "/zytk/zytk35_mpos/sh/";
    ...
    public static NetEventMsg g_NetEventMsg;
    ...
    public static HttpCommInfo g_HttpCommInfo;
    ...
    public static Handler g_UIMainHandler;//主界面UI刷新
    public static Handler g_UIStartHandler;//开始界面UI刷新
    public static Handler g_UICardHandler;//刷卡界面UI刷新
    public static Handler g_UIRDCardHandler;//冲正刷卡界面UI刷新

    public static Display g_ExtDisplay;      //副屏显示
